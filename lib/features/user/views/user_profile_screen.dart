...
import 'package:tiktok_clone/features/user/views/update_profile_screen.dart';
import 'package:tiktok_clone/features/user/views/widgets/avatar.dart';
import 'package:tiktok_clone/features/user/views/widgets/persistent_tab_bar.dart';
                      ...
                      headerSliverBuilder: (context, innerBoxIsScrolled) {
                        return [
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      VerticalDivider(
                                        ...
                                        indent: Sizes
                                            .size14, // father높이의 얼마부터 시작할 것인지
                                        endIndent: Sizes
                                            .size14, // father높이의 얼마전에 끝날 것인지
                          ...
                          SliverPersistentHeader(
                            delegate:
                                PersistentTabBar(), // delegate를 통해 탭바를 build한다.
                            pinned: true, // 상단에 고정.
                          ),
                        ];
                      },
                      body: TabBarView(children: [
                        GridView.builder(
                          ...
                          gridDelegate:
                            ...
                            childAspectRatio: 9 /
                                14, // 그리드의 비율. 그림은 9/16. 4를 추가하여 텍스트 자리를 만들었다.
                          ),
                              ...
                              children: [
                                AspectRatio(
                                  ...
                                  child: FadeInImage.assetNetwork(
                                    ...
                                    fit: BoxFit
                                        .cover, // 불러온 이미지가 어떻게 채워질 것인지 정하는 옵션
